...
class ProjectsTest(unittest.TestCase):
    ...
    def test_new_project(self):
        ...
        rest.expect_post(ProjectsClient._REST_ENDPOINT_PREFIX, check_input, 200, {'uuid': 'aaa'})
        ...
        rest.expect_post(ProjectsClient._REST_ENDPOINT_PREFIX, check_input, 200, {'uuid': 'ccc'})
        ...
        rest.expect_post(ProjectsClient._REST_ENDPOINT_PREFIX, check_input, 404, {})
    ...
    def test_get_project(self):
        ...
        rest.expect_get(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 200, {'uuid': 'aaa'})
        ...
        rest.expect_get(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 404, {})
        project = projects.get_project('aaa')
        self.assertEqual(project, None)

        rest.expect_get(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 403, {})
        with self.assertRaises(RuntimeError):
            project = projects.get_project('aaa')
    ...
    def test_get_sub_projects(self):
        ...
        rest.expect_get(ProjectsClient._REST_ENDPOINT_PREFIX, 200, projects_response)
    ...
    def test_delete_project(self):
        ...
        rest.expect_delete(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 204)
        projects.delete_project('aaa')

        # 200 isn't a valid return value for delete calls right now
        rest.expect_delete(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 200)
        with self.assertRaises(RuntimeError):
            projects.delete_project('aaa')

        rest.expect_delete(f"{ProjectsClient._REST_ENDPOINT_PREFIX}/aaa", 404)
        with self.assertRaises(RuntimeError):
            projects.delete_project('aaa')
