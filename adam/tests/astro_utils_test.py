...
class AstroUtilsTest(unittest.TestCase):
    ...
    def test_icrf_to_ecliptic(self):
        ecliptic_pos_vel = astro_utils.icrf_to_jpl_ecliptic(ICRF_X, ICRF_Y,
        ICRF_Z, ICRF_VX, ICRF_VY, ICRF_VZ)
    ...
    def test_ecliptic_to_icrf(self):
        ...
        JPL_ECLIPTIC_Z, JPL_ECLIPTIC_VX, JPL_ECLIPTIC_VY, JPL_ECLIPTIC_VZ)
